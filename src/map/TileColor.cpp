...
uint8_t tileColors[] = {
    ...
    12, 237, 255, 76, 76, 115, 173, 229, 115, 173, 229, 119, 101, 125, 141,
    120, 168, 192, 202, 203, 200, 200, 200, 141, 107, 89, 210, 91, 77, 21, 124,
    212, 149, 232, 87, 135, 196, 26, 127, 92, 69, 107, 182, 0, 177, 183, 161,
    170, 48, 114, 237, 218, 244, 247, 228, 254, 122, 217, 232, 128, 128, 128,
    128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128,
    126, 102, 118, 245, 215, 196, 223, 255, 255, 164, 175, 175, 77, 176, 144,
    185, 190, 20, 185, 190, 20, 185, 190, 20, 229, 65, 65, 30, 30, 36, 119, 22,
    52, 23, 119, 79, 23, 54, 119, 119, 68, 23, 74, 23, 119, 78, 82, 109, 115,
    69, 27, 160, 115, 80, 235, 200, 20, 240, 130, 160, 65, 75, 65, 210, 170,
    215, 90, 125, 235, 211, 211, 211, 160, 90, 50, 26, 141, 204, 227, 227, 227,
    106, 103, 96, 120, 114, 108, 122, 78, 21, 231, 178, 28, 2, 114, 206, 122,
    122, 122, 122, 122, 122, 128, 128, 128, 128, 128, 128
};
...
uint8_t wallColors[] = {
    ...
    100, 40, 1, 92, 30, 72, 42, 81, 1, 1, 81, 109, 56, 22, 97, 52, 52, 52, 100,
    65, 130, 120, 75, 75, 52, 52, 52, 0, 255, 0, 80, 58, 40, 118, 100, 10, 14,
    54, 34, 120, 65, 80, 32, 38, 32, 105, 85, 108, 45, 62, 118, 80, 45, 25, 13,
    70, 102, 73, 93, 116, 53, 52, 48, 60, 57, 54, 61, 39, 10, 116, 89, 14, 1,
    57, 103, 61, 61, 61
};
...
Color::Color(uint8_t *data)
{
    std::copy(data, data + 3, rgb);
}
...
void Color::hueBlend(Color tint)
{
    ...
    uint8_t primary;
    double secondary;
    rgbMax = *std::max_element(tint.rgb, tint.rgb + 3);
    rgbMin = *std::min_element(tint.rgb, tint.rgb + 3);
...
Color getTileColor(int x, int y, World &world)
{
    ...
    if (tile.blockID != TileID::empty) {
        Color blockColor{tileColors + 3 * tile.blockID};
        if (tile.actuated) {
