...
inline const std::set<int> nonSolidTiles{
    TileID::empty,         TileID::alchemyTable, TileID::amberTree,
    TileID::amethystTree,  TileID::ashTree,      TileID::bathtub,
    ...
    TileID::clock,         TileID::diamondTree,  TileID::dresser,
    TileID::emeraldTree,   TileID::gem,          TileID::hellforge,
    TileID::lantern,       TileID::largePile,    TileID::largePileGroup2,
    TileID::lihzahrdAltar, TileID::painting2x3,  TileID::painting3x2,
    TileID::painting3x3,   TileID::painting6x4,  TileID::palmTree,
    TileID::piano,         TileID::pot,          TileID::pressurePlate,
    TileID::rollingCactus, TileID::rope,         TileID::rubyTree,
    TileID::sakuraTree,    TileID::sapphireTree, TileID::silverCoin,
    TileID::sink,          TileID::smallPile,    TileID::statue,
    TileID::table,         TileID::TNTBarrel,    TileID::toilet,
    TileID::topazTree,     TileID::tree,         TileID::waterCandle,
    TileID::woodenBeam,    TileID::workBench,    TileID::yellowWillowTree,
};
