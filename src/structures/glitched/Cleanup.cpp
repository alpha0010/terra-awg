...
constexpr std::array glitchedTiles{
    ...
    TileID::snowCloud,
    TileID::solarBrick,
    TileID::solarFragment,
    TileID::spiderNest,
    TileID::spike,
    TileID::starCloud,
    TileID::stardustBrick,
    TileID::stardustFragment,
...
void applyGlitchedFinalize(int x, int y, Random &rnd, World &world)
{
    ...
    if (isSolidBlock(tile.blockID)) {
        if (!world.getFramedTiles()[tile.blockID] && randInt % 5659 < 20) {
