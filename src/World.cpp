...
namespace
{
constexpr auto tileFrameData =
    frozen::make_map<std::pair<int, Variant>, FrameDetails>({
...
void World::placeFramedTile(int x, int y, int blockID, Variant type, int paint)
{
    ...
    int frameWidth = 2;
    int frameHeight = 2;
    auto itr = tileFrameData.find(std::pair{blockID, type});
...
namespace
{
constexpr auto paintingData = frozen::make_map<Painting, PaintingDetails>({
    ...
    {Painting::bannerOfTheBeast, {TileID::painting3x3, 1296, 108}},
    {Painting::bloodMoonRising, {TileID::painting3x3, 648, 0}},
    {Painting::boneWarp, {TileID::painting3x3, 810, 0}},
    {Painting::bouldAndBash, {TileID::painting3x3, 1404, 108}},
    ...
    {Painting::remix, {TileID::painting3x3, 1512, 108}},
